...
type NewCharacterProps = {
    addCharacter: (character: {name: string; status: string; species: string; originName: string}) => void;
};
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="text" id="origin" name="origin" value={formData.originName} onChange={handleChange}/>
